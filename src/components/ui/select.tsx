...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-12 w-full items-center justify-between rounded-lg border-2 border-input bg-card px-3 py-2 text-base',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex min-h-12 w-full cursor-pointer select-none items-center rounded-lg py-2 pl-9 pr-3 text-base outline-none',
